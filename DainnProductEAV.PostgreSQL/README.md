...
```bash
dotnet add reference ../DainnProductEAV.PostgreSQL/DainnProductEAV.PostgreSQL.csproj
```

Or add as a NuGet package (when published):

```bash
dotnet add package DainnProductEAV.PostgreSQL
```
