...
```bash
dotnet add package DainnUserManagement
```

Or install locally:

```bash
cd DainnUserManagement
dotnet pack
dotnet add ../YourProject/YourProject.csproj reference DainnUserManagement --package-source ../DainnUserManagement/bin/Debug
```
...
```json
{
  ...
  "OpenTelemetry": {
    ...
    "ServiceName": "DainnUserManagement",
